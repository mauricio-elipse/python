...
Exemplo de como proceder com a leitura de dados históricos (base diária) do período em que o ar condicionado de uma sala permaneceu ligado. A partir deste valor estima-se o custo relacionado através de uma simulação no site de uma concessionária de energia.


## Exemplo 2 - função para a estimativa do valor da temperatura para a próxima meia hora em uma sala - utilização do scikit learn.
